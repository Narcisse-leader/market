        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsFurni">
                <ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
                    <li class="nav-item ">
                        <a class="nav-link" href="{{ route('recycle.index') }}">Home</a>
                    </li>
                    <li><a class="nav-link" href="{{ route('recycle.shop') }}">Shop</a></li>
                    <li><a class="nav-link" href="{{ route('recycle.about') }}">About us</a></li>
                    <li><a class="nav-link" href="{{ route('recycle.services') }}">Services</a></li>
                    <!-- <li><a class="nav-link" href="blog.html">Blog</a></li> -->
                    <li><a class="nav-link" href="{{ route('recycle.contact') }}">Contact us</a></li>
                </ul>
